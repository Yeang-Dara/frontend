    ...
    navigation: [
      {
        ...
        items: [
          {
            title: "Dashboard",
            link: "/employee/dashboardemployee",
        ...
        items: [
          {
            ...
            items: [
              {
                title: "List Machine",
                link: "/employee/atmemployee",
                icons: "mdi-home-group",
              },
              {
                title: "Add Machine ",
                link: "/employee/addnewmachine",
                icons: "mdi-home-plus",
              },
            ],
          },
